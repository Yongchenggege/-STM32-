...
/*****	功能函数	 *****/
uint8_t TCS34725_Init(void);						// 初始化TCS34725配置
void TCS34725_Enable(void);					// 使能器件
void TCS34725_Disable(void);        // 失能器件
void TCS34725_SetGain(uint8_t gain);		// 设置增益
void TCS34725_SetIntegrationTime(uint8_t time);		// 设置时间增益
